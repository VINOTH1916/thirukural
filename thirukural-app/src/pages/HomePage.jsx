    ...
    <div className="home-page">
      ...
      <div className="hero">
        ...
        <div className="hero-stats">
          <div className="stat"><span>133</span><label>அதிகாரங்கள்</label></div>
          <div className="stat-div" />
          <div className="stat"><span>1330</span><label>குறள்கள்</label></div>
          <div className="stat-div" />
          <div className="stat"><span>3</span><label>பால்கள்</label></div>
        </div>
      </div>
